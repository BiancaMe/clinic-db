...
Clinic Database is a database to create the data structure for a clinic. 
...
- Create a Database 
- Structure medical_histories for patients
- Structure treatments and invoices
...
```sh
  cd my-folder
  git clone https://github.com/BiancaMe/clinic-db
  cd clinic-db
```
